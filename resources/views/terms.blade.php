	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-10" style="margin:0 auto">
				<div>
					<a href="{{url('/')}}" ><img width="200" src="{{asset('subscribers/img/aprlogo.png')}}" alt="" ></a>
                    <br><br>
					...
					<div>
                        ...
                        <p><strong>Profile Data</strong>&nbsp;&ndash; this will including your name, address, email address and telephone number, job function/title, business demographics in relation to your role, business interests, business areas, business expertise. This be supplied by you when you register a profile, complete surveys, take part in competitions/polls, contribute services (e.g. editorial services), contribute to our Publications, attend or contribute to events, register enquiry or tell us about any problems with our Site. This data be processed for enabling and monitoring your use of our Site, products and services.</p>
                        ...
                        <ol start="4">
                            <li><strong>
                                    <ul>
                                        <li style="list-style-type:decimal;font-size:13pt;">
                                            <p>How personal data is collected</p>
                                        </li>
                                    </ul>
                                </strong></li>
                        </ol>
                        ...
                        <ul>
                            <li >
                                <p>request our products or services (e.g. a digital or print magazine);</p>
                            </li>
                            <li >
                                <p>create an account on one of our websites;</p>
                            </li>
                            <li >
                        ...
                        <ul>
                            <li >
                                <p>Identity, Contact and Technical Data from the following parties:</p>
                            </li>
                        </ul>
                        ...
                        <p>Where we need to perform the contract we are about to enter into or have entered into with you.<br><br></p>
                        ...
                        <p><br>Where we need to comply with a legal or regulatory obligation.</p>
                        ...
                        <p>&nbsp;the establishment, exercise or defence of legal claims &ndash; the legal basis for this is our legitimate interests, in particular the protection and assertion of our legal rights, your legal rights or the legal rights of others.</p>
                        ...
                        <p>You may contact us to let us know that you do not wish us to process your Personal Data&nbsp;</p>
                        ...
                        <p>Any member of our Group insofar as reasonably necessary for the purposes, and on the legal grounds, set out in this privacy policy.</p>
                        <p><br>Our insurers and/or professional advisers as may be reasonably necessary for the purposes of obtaining or maintain insurance, &nbsp;managing risk, taking professional advice, or the establishment, exercise, defence of legal claim.</p>
                        <p><br>A purchaser in circumstances where the Company or substantially all of its assets are acquired by a third party, in which case personal data held by the Company will be one of the transferred assets.<br><br></p>
                        <p>Other third parties: who supply goods and/or services to the Group in order that Group may perform its contractual, legal and other obligations including, but not limited to, our suppliers and sub-contractors, service providers, distribution services, telemarketing services, debt collection services;</p>
                        <p><br><strong>I</strong>f we are under a duty to disclose or share your Personal Data in order to :</p>
                        <ul>
                            <li >
                                <p><br>comply with any legal obligation, or in order to enforce or apply Terms; or</p>
                            </li>
                            <li >
                                <p><br>to protect the rights, property, or safety of Pharvers, our customers, or others. This includes exchanging information with other companies and organisations for the purposes of fraud protection and credit risk reduction;</p>
                            </li>
                            <li >
                                <p><br>to assist us in improving our products and services. We monitor aggregated data that is collected by our Service and may share this with third parties collectively and in an anonymous way. This data will not reveal personal information</p>
                            </li>
                        </ul>
                        <p><br></p>
                        ...
                        <ol start="9">
                            <li><strong>
                                    <ul>
                                        <li style="list-style-type:decimal;font-size:13pt;">
                                            <p>Safeguarding and protecting of your personal information</p>
                                        </li>
                                    </ul>
                                </strong></li>
                        </ol>
                        ...
                        <ol start="11">
                            <li style="list-style-type:decimal;font-size:13pt;">
                                <p><strong>The Use of Cookies and web beacons&nbsp;</strong></p>
                            </li>
                        </ol>
                        ...
                        <ol start="13">
                            <li style="list-style-type:decimal;font-size:13pt;">
                                <p><strong>Use of Hyperlinks&nbsp;</strong></p>
                            </li>
                        </ol>
